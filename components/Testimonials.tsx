        ...
        <div className="flex flex-col lg:flex-row gap-10 lg:gap-16">
            ...
            <div className="lg:w-1/2 grid grid-cols-1 md:grid-cols-2 gap-6">
                {TESTIMONIALS.map((item, idx) => (
                    <FadeIn key={item.id} delay={idx * 0.1} direction="left">
                      <div className="bg-[#0E1F14] text-white p-6 md:p-8 rounded-[1.5rem] relative flex flex-col justify-between min-h-[280px] md:min-h-[320px] group hover:-translate-y-2 transition-transform duration-300">
